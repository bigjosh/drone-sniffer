...
// 6 exercises the XIAO, which listens there permanently. Any other channel can
// only be picked up by the Heltec's hopping scan, which isolates that path.
static const int      TX_CHANNEL   = 6;
